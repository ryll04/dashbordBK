...
@section('header', 'Tambah Kategori Bouquet')
...
<div class="card" style="max-width: 600px;">
    <form action="{{ route('admin.kategori.store') }}" method="POST">
        ...
        <div style="margin-bottom: var(--space-lg);">
            ...
            <input type="text" id="nama_kategori" name="nama_kategori" class="form-input" value="{{ old('nama_kategori') }}" required>
            @error('nama_kategori')
        ...
        <div style="margin-bottom: var(--space-lg);">
            ...
            <textarea id="deskripsi_kategori" name="deskripsi_kategori" class="form-input" rows="4">{{ old('deskripsi_kategori') }}</textarea>
        ...
        <div style="margin-bottom: var(--space-xl);">
            ...
            <select id="status_kategori" name="status_kategori" class="form-input">
                <option value="aktif" {{ old('status_kategori') == 'aktif' ? 'selected' : '' }}>Aktif</option>
                <option value="nonaktif" {{ old('status_kategori') == 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
            </select>
